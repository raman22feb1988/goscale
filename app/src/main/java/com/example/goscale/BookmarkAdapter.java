...
public class BookmarkAdapter extends RecyclerView.Adapter<BookmarkAdapter.ViewHolder> {
    ...
    public BookmarkAdapter(Context context, int resource, List<Movie> li, String query, String text, int page, Bookmark bookmark) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        public ViewHolder(View itemView) {
            ...
            ima = itemView.findViewById(R.id.imageview5);
            tx1 = itemView.findViewById(R.id.textview8);
            tx2 = itemView.findViewById(R.id.textview9);
        }
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        final ImageView i1 = thingView.findViewById(R.id.imageview6);
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent5 = new Intent(con, Home.class);
                intent5.putStringArrayListExtra("imdbId", bookmark.getImdbId());
                intent5.putStringArrayListExtra("poster", bookmark.getPoster());
                intent5.putStringArrayListExtra("title", bookmark.getTitle());
                intent5.putStringArrayListExtra("year", bookmark.getYear());
                intent5.putStringArrayListExtra("type", bookmark.getType());

                intent5.putExtra("query", query);
                intent5.putExtra("text", text);
                intent5.putExtra("page", page);
                con.startActivity(intent5);
                ((Activity) con).finish();
            }
        });
